--Reference Data:
DROP TABLE IF EXISTS Superhero_DB.dbo.superpower;
DROP TABLE IF EXISTS Superhero_DB.dbo.superhero;
DROP TABLE IF EXISTS Superhero_DB.dbo.gender;
DROP TABLE IF EXISTS Superhero_DB.dbo.colour;
DROP TABLE IF EXISTS Superhero_DB.dbo.attribute;
DROP TABLE IF EXISTS Superhero_DB.dbo.race;
DROP TABLE IF EXISTS Superhero_DB.dbo.publisher;
DROP TABLE IF EXISTS Superhero_DB.dbo.alignment;
DROP TABLE IF EXISTS Superhero_DB.dbo.superhero_temp;
DROP TABLE IF EXISTS Superhero_DB.dbo.hero_attribute;


CREATE TABLE Superhero_DB.dbo.alignment (
  id INT NOT NULL,
  alignment VARCHAR(10) DEFAULT NULL,
  PRIMARY KEY (id)
);

INSERT INTO Superhero_DB.dbo.alignment VALUES (1,'Good'),
(2,'Bad'),
(3,'Neutral'),
(4,'N/A');

CREATE TABLE Superhero_DB.dbo.attribute (
  id INT NOT NULL,
  attribute_name VARCHAR(200) DEFAULT NULL,
  PRIMARY KEY (id)
);

INSERT INTO Superhero_DB.dbo.attribute VALUES
(1,'Intelligence'),
(2,'Strength'),
(3,'Speed'),
(4,'Durability'),
...
CREATE TABLE Superhero_DB.dbo.colour (
  id INT NOT NULL,
  colour VARCHAR(20) DEFAULT NULL,
  PRIMARY KEY (id)
);

INSERT INTO Superhero_DB.dbo.colour VALUES (1,'No Colour'),
(2,'Amber'),
(3,'Auburn'),
(4,'Black'),
(5,'Black/Blue'),
...
CREATE TABLE Superhero_DB.dbo.gender (
  id INT NOT NULL,
  gender VARCHAR(20) DEFAULT NULL,
  PRIMARY KEY (id)
);

INSERT INTO Superhero_DB.dbo.gender VALUES (1,'Male'),
(2,'Female'),
(3,'N/A');


CREATE TABLE Superhero_DB.dbo.publisher (
  id INT NOT NULL,
  publisher_name VARCHAR(50) DEFAULT NULL,
  PRIMARY KEY (id)
);

INSERT INTO Superhero_DB.dbo.publisher VALUES (1,''),
(2,'ABC Studios'),
(3,'Dark Horse Comics'),
(4,'DC Comics'),
(5,'George Lucas'),
...
CREATE TABLE Superhero_DB.dbo.race (
  id INT NOT NULL,
  race VARCHAR(100) DEFAULT NULL,
  PRIMARY KEY (id)
);

INSERT INTO Superhero_DB.dbo.race VALUES (1,'-'),
(2,'Alien'),
(3,'Alpha'),
(4,'Amazon'),
(5,'Android'),
...
CREATE TABLE Superhero_DB.dbo.superhero (
  id INT NOT NULL,
  ...
  PRIMARY KEY (id),
  CONSTRAINT fk_sup_align FOREIGN KEY (alignment_id) REFERENCES Superhero_DB.dbo.alignment (id),
  CONSTRAINT fk_sup_eyecol FOREIGN KEY (eye_colour_id) REFERENCES Superhero_DB.dbo.colour (id),
  CONSTRAINT fk_sup_gen FOREIGN KEY (gender_id) REFERENCES Superhero_DB.dbo.gender (id),
  CONSTRAINT fk_sup_haircol FOREIGN KEY (hair_colour_id) REFERENCES Superhero_DB.dbo.colour (id),
  CONSTRAINT fk_sup_pub FOREIGN KEY (publisher_id) REFERENCES Superhero_DB.dbo.publisher (id),
  CONSTRAINT fk_sup_race FOREIGN KEY (race_id) REFERENCES Superhero_DB.dbo.race (id),
  CONSTRAINT fk_sup_skincol FOREIGN KEY (skin_colour_id) REFERENCES Superhero_DB.dbo.colour (id)
);

INSERT INTO Superhero_DB.dbo.superhero VALUES
...
CREATE TABLE Superhero_DB.dbo.superpower (
  id INT NOT NULL,
  power_name VARCHAR(200) DEFAULT NULL,
  PRIMARY KEY (id)
);

INSERT INTO Superhero_DB.dbo.superpower VALUES (1,'Agility'),
...
CREATE TABLE Superhero_DB.dbo.hero_attribute (
  hero_id INT DEFAULT NULL,
  attribute_id INT DEFAULT NULL,
  attribute_value INT DEFAULT NULL,
  CONSTRAINT fk_hat_at FOREIGN KEY (attribute_id) REFERENCES Superhero_DB.dbo.attribute (id),
  CONSTRAINT fk_hat_hero FOREIGN KEY (hero_id) REFERENCES Superhero_DB.dbo.superhero (id)
);

INSERT INTO Superhero_DB.dbo.hero_attribute (hero_id, attribute_id, attribute_value) VALUES
(1,1,80),
(2,1,75),
(3,1,95),
(4,1,80),
...
--Hero Power Script
DROP TABLE IF EXISTS Superhero_DB.dbo.hero_power;

CREATE TABLE Superhero_DB.dbo.hero_power (
  hero_id INT DEFAULT NULL,
  power_id INT DEFAULT NULL,
  CONSTRAINT fk_hpo_hero FOREIGN KEY (hero_id) REFERENCES Superhero_DB.dbo.superhero (id),
  CONSTRAINT fk_hpo_po FOREIGN KEY (power_id) REFERENCES Superhero_DB.dbo.superpower (id)
);

INSERT INTO Superhero_DB.dbo.hero_power (hero_id, power_id) VALUES
(1,1),
(1,18),
(1,26),
(1,31),
